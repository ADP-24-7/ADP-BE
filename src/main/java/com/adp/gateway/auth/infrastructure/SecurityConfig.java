    ...
    SecurityFilterChain adminSecurityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/admin/ai/evaluation-runs/*/transform-governance-profile")
                    .hasAnyRole("OPERATOR", "PRIVILEGED_OPERATOR", "AUDITOR")
                .requestMatchers("/api/admin/ai/evaluation-runs/*/bundle")
                    .hasAnyRole("PRIVILEGED_OPERATOR", "AUDITOR")
                ...
                .requestMatchers(HttpMethod.POST, "/api/admin/reference-evidence/bundles")
                    .hasRole("PRIVILEGED_OPERATOR")
                .requestMatchers(HttpMethod.POST, "/api/admin/reference-evidence/*/versions/*/policy-bindings")
                    .hasRole("PRIVILEGED_OPERATOR")
                .requestMatchers(HttpMethod.POST, "/api/admin/regulatory-refresh")
                    .hasRole("PRIVILEGED_OPERATOR")
